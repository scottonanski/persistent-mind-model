...
def test_hot_strength_computation():
    ...
    try:
        ...
        for gas, close_rate, expected in test_cases:
            ...
            print(f"  GAS={gas:.1f}, Close={close_rate:.1f} → Hot Strength={result:.3f} (expected ~{expected:.3f})")
...
def test_environment_variables():
    ...
    # Set test values
    for var in env_vars:
        os.environ[var] = "0.5" if "FLOOR" in var or "BOOST" in var or "PENALTY" in var else "1"
