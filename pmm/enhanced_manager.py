...
from .enhanced_model import (
    EnhancedPersistentMindModel, NextStageConfig, 
    EnhancedSelfKnowledge, EnhancedMetrics
)
from .model import Event, Thought, Insight, PersistentMindModel
...
class EnhancedSelfModelManager:
    ...
    def __init__(self, 
        ...
        _log(f"Enhanced PMM Manager initialized with next-stage: {self.enable_next_stage}")
    ...
    def add_event(self, summary: str, effects: Optional[List[dict]] = None, *, etype: str = "experience"):
        ...
        with self.lock:
            ...
            if (self.enable_next_stage and 
                hasattr(self, 'tokenization_engine') and
                self.config.enable_memory_tokens):
    ...
    def recall_memories(self, cue: str, max_results: int = 5) -> List[RecallResult]:
        ...
        try:
            ...
            # Update metrics
            self.model.metrics.recall_accuracy = len(results) / max_results if max_results > 0 else 0.0
    ...
    def export_identity(self, export_path: str, include_archives: bool = True) -> ExportManifest:
    ...
    def _save_enhanced_model_unlocked(self, model: Optional[EnhancedPersistentMindModel] = None):
    ...
    def add_commitment(self, text: str, source_insight_id: str, due: Optional[str] = None):
        """Add commitment."""
