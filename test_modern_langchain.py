    ...
    def invoke(self, messages):
        ...
        if "remember" in user_input.lower():
            return MockAIMessage(
                "Yes, I remember our previous conversations! Let me check my history..."
            )
        elif "talk about" in user_input.lower():
            return MockAIMessage(
                "Looking at our conversation history, we discussed personality traits and memory systems."
            )
        else:
            return MockAIMessage(
                f"Thanks for saying: '{user_input}'. I'm responding with my personality traits in mind!"
            )
...
def test_modern_langchain_features():
    ...
    test_inputs = ["Hello!", "Do you remember me?", "What did we talk about last time?"]
